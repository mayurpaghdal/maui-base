...
public class LoginPageViewModel : BaseViewModel
{
    ...
    #region Commands
    public IAsyncRelayCommand InitiateMsLoginCommand { get; set; }
    #endregion
    ...
    {
        InitiateMsLoginCommand = new AsyncRelayCommand(InitiateMsLogin);
    }

    private async Task InitiateMsLogin()
    {
        try
        {
    ...
    public override async void OnRecurringNavigatedTo(INavigationParameters parameters)
    {
        try
        {
